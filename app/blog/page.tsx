...
const posts = [
  ...
  { slug: "non-gmo-soya-meal-manufacturer-india", image: "public/non-gmo soya meal manufacture in india.png", title: "Non-GMO Soya Meal Manufacturer in India — Why It Matters for Your Supply Chain", description: "What non-GMO soya meal certification means, why India is uniquely positioned as a non-GMO soya producer, and how SVF Soya documents its non-GMO status for domestic and export buyers.", category: "Quality & Testing", date: "May 5, 2026", readTime: "7 min read" },
  ...
  { slug: "non-gmo-soybean-supplier-india", image: "/non-gmo soyabean supplier in india.png", title: "Non-GMO Soybean Supplier in India — Sourcing Clean Raw Soybeans for Processing", description: "Where India's non-GMO soybeans are grown, quality parameters for raw soybean supply, SVF Soya's procurement and QC process, moisture-controlled warehousing, and bulk dispatch logistics.", category: "Quality & Testing", date: "April 25, 2026", readTime: "7 min read" },
