...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "soybean supplier Bengaluru",
    "soybean exporter India",
    "soybean exporter from India",
    "soybean exporter Karnataka",
    "soyabean supplier India",
    "soyabean supplier Karnataka",
    "soyabean exporter India",
    "soyabean exporter from India",
    "soya bean supplier India",
    "soya bean exporter India",
    "soy bean supplier India",
    "soy bean exporter India",
    "non GMO soybean supplier India",
    "non GMO soybean supplier Karnataka",
    "non GMO soybean exporter India",
    "non GMO soyabean supplier India",
    "non GMO soyabean exporter India",
    "non GMO soya bean supplier India",
    "raw soybeans bulk supplier India",
    "raw soybeans for processing India",
    "soybeans for oil extraction India",
    "soybeans moisture controlled storage",
    "clean sourced soybeans Karnataka",
    "bulk soybean supply India",
  ],
