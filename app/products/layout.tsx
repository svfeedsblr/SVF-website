...
export const metadata: Metadata = {
  ...
  description:
    "Explore SVF Soya's product range: high-protein Soya Meal (47%+ protein), Full Fat Soya Meal, Crude Soybean Oil, and Raw Soybeans. Chemical-free, non-GMO, FSSAI certified.",
  keywords: [
